    ...
    <div class="onboarding">
      <div class="scroll-wrap">
        <div class="features-item">
          ...
          <iframe v-if="globalConfig.userOnboardingVideoURL" width="560" height="315" :src="globalConfig.userOnboardingVideoURL" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
        <div class="features-item">
