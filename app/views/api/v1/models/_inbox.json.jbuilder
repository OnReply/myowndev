...
if resource.whatsapp?
  ...
  json.reauthorization_required (resource.channel.provider_config['token_expiry_date'].to_date - Date.today).to_i < 7 if resource.channel.provider == 'whatsapp_cloud'
end
