...
class AutomationRule < ApplicationRecord
  ...
  ACTIONS_ATTRS = %w[send_message add_label send_email_to_team assign_team assign_agent send_webhook_event mute_conversation send_attachment
                     change_status resolve_conversation snooze_conversation open_conversation pending_conversation close_conversation change_priority send_email_transcript 
                     send_whatsapp_template remove_label].freeze
